...
// create getCat function to get single cat
...
// Tuse Utility type to modify Cat type for 'data'.
// Note that owner is not User in this case. It's just a number (user_id)
const addCat = async (data: Omit<Cat, 'cat_id'>): Promise<number> => {
...
// create updateCat function to update single cat
